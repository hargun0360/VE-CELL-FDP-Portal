...
export const ADD_BULK_STUDENT_URL = BASE_URL + ''
export const GET_ALL_STUDENT = BASE_URL + ''
export const DELETE_STUDENT_URL = BASE_URL + ''
export const ADD_STUDENT_URL = BASE_URL + ''
export const GET_STUDENT_BY_ID = BASE_URL + ''
export const UPDATE_STUDENT_URL = BASE_URL + ''